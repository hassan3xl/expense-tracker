      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 space-y-6">
          {currentProj.role === "viewer" ? (
            <div className="flex flex-col items-center justify-center p-6 text-center border border-dashed border-border rounded-lg bg-card min-h-[300px]">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="border border-border bg-card rounded-lg p-4 sm:p-5">
