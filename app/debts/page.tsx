  ...
  return (
    <main className="">
      ...
      <div>
        <Suspense
          fallback={
            <div className="h-10 bg-muted border border-border rounded-xl" />
          }
        >
          <DebtFilters />
        </Suspense>
      ...
      {/* Debts List Card */}
      <div>
        <Card className="hidden md:block border border-border bg-card text-card-foreground rounded-3xl p-5 sm:p-6">
