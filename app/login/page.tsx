        ...
        <Card className="ring-1 ring-border">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                {isPending ? (
                  <div className="size-5 rounded-full border-2 border-primary-foreground/30 border-t-primary-foreground" />
                ) : (
                  <>
                    <span>Sign In</span>
          ...
          <CardFooter className="justify-center">
            <p className="text-sm text-muted-foreground">
              ...
              <Link
                href="/register"
                className="group/link inline-flex items-center gap-1 font-medium text-primary hover:text-primary/80"
              >
                Create Account
