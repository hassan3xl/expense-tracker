...
export default function ManageMembersDialog({
  ...
  return (
    <UIDialog open={open} onOpenChange={setOpen}>
      ...
      <UIDialogContent className="sm:max-w-md border border-border bg-popover text-popover-foreground rounded-3xl p-6">
        <UIDialogHeader>
        ...
        <form
          ...
          className="mt-4 space-y-3 p-4 rounded-2xl border border-border bg-card"
        >
        ...
        <div className="mt-4 space-y-3">
          ...
          {loading ? (
            <div className="flex flex-col items-center justify-center py-8 text-muted-foreground">
              <Loader2 className="size-6 text-primary mb-2" />
            ...
            <div className="max-h-60 overflow-y-auto space-y-2 pr-1 custom-scrollbar">
              ...
              {members.map((member) => (
                <div
                  key={member.id}
                  className="flex items-center justify-between p-3 rounded-xl border border-border bg-card hover:bg-muted"
                >
                  <div className="flex items-center gap-2.5">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="bg-background text-foreground text-xs border border-border rounded-lg px-2.5 py-1 outline-none cursor-pointer hover:bg-muted disabled:opacity-50 appearance-none pr-6"
                      >
                        <option value="editor">Editor</option>
                        <option value="viewer">Read-Only</option>
                      </select>
